...
namespace onsales.Web.Controllers
{
    public class CountriesController : Controller
    {
        ...
        {
            return View(await _context.Countries.ToListAsync());//Retorna la lsta 
        }
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            Country country = await _context.Countries
                .Include(c => c.Departments)//Si quitamos esta fila, enviara un error de eliminacion
                .ThenInclude(d => d.Cities)//Si quitamos esta fila, enviara un error
                .FirstOrDefaultAsync(m => m.Id == id);
            if (country == null)
            {
                return NotFound();
        ...
        public async Task<IActionResult> AddCity(int? id)
        {
            ...
            City model = new City { IdDepartament = department.Id };
            return View(model);
        }
        ...
        public async Task<IActionResult> AddCity(City city)
        {
            if (ModelState.IsValid)
            {
                Department department = await _context.Departments
                    .Include(d => d.Cities)
                    .FirstOrDefaultAsync(c => c.Id == city.IdDepartament);
                if (department == null)
                {
                    return NotFound();
                }
        ...
        public async Task<IActionResult> EditCity(int? id)
        {
            ...
            city.IdDepartament = department.Id;
            return View(city);
        }
        ...
        public async Task<IActionResult> EditCity(City city)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    await _context.SaveChangesAsync();
                    return RedirectToAction($"{nameof(DetailsDepartment)}/{city.IdDepartament}");
